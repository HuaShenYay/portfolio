                ...
                {posts.map((post: Post, index: number) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div class="max-w-3xl">
                          <p class="text-[14px] text-gray-400 font-medium mb-4 uppercase tracking-widest">Essay</p>
                          <h3 class={`${isLarge ? "text-[32px]" : "text-[24px]"} font-bold leading-tight tracking-tight mb-4 text-black`}>
                            {title}
                          </h3>
                          {preview && (
